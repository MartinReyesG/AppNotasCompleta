...
class  NotificationUtils(base: Context) : ContextWrapper(base) {
    ...
    fun getNotificationBuilder(titulo:String): NotificationCompat.Builder {
        ...
        val notificacionLayout = RemoteViews(packageName, R.layout.noti)
        val notidicacionLayoutExp = RemoteViews(packageName, R.layout.noti_exp)
        ...
        return NotificationCompat.Builder(applicationContext, MYCHANNEL_ID)
            ...
            .setAutoCancel(true)
            .setCustomContentView(notificacionLayout)
            .setCustomBigContentView(notidicacionLayoutExp)
    }
}